...
/* ── Inline SVG icons (lucide style, 40×40 strokeWidth=1.75) ── */

function ShieldIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export default function Benefits() {
  return (
    <section id="benefits" className="py-16 px-6" style={{ backgroundColor: "#FFFFFF" }}>
...
function BenefitCard({
  ...
  return (
    <div
      className="group relative rounded-xl p-10 flex flex-col gap-4 transition-all duration-300"
      style={{
      ...
      onMouseEnter={(e) => {
        ...
        el.style.paddingTop = "calc(2.5rem - 2px)";
      }}
      onMouseLeave={(e) => {
        const el = e.currentTarget;
    ...
    >
      ...
      {/* Title */}
      <h3 className="text-xl font-bold leading-snug" style={{ color: "#1A1A1A" }}>
        {title}
      </h3>
